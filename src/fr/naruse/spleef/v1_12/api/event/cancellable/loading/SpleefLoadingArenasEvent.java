package fr.naruse.spleef.v1_12.api.event.cancellable.loading;
...
public class SpleefLoadingArenasEvent extends SpleefCancellableEvent {
    ...
    public SpleefLoadingArenasEvent(SpleefPluginV1_12 pl, String eventName) {
        super(pl, eventName);
    }
    ...
    public static class Pre extends SpleefLoadingArenasEvent {
        private String name;
        public Pre(SpleefPluginV1_12 pl, String name) {
    ...
    public static class Post extends SpleefLoadingArenasEvent {
        ...
        public Post(SpleefPluginV1_12 pl, String name, Spleef spleef, Location spleefLoc, Location spleefSpawn, Location spleefLobby, int min, int max, boolean isOpen, SpleefGameMode gameMode, Location regionPos1, Location regionPos2) {
