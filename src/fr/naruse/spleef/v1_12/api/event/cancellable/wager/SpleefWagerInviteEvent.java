...
public class SpleefWagerInviteEvent extends SpleefCancellableEvent {
    public SpleefWagerInviteEvent(SpleefPluginV1_12 pl, String eventName) {
        super(pl, eventName);
    }
    ...
    public static class Pre extends SpleefWagerInviteEvent{
        ...
        private Wager wager;
        public Pre(SpleefPluginV1_12 pl, Player p, Player p2, Wager wager) {
    ...
    public static class Post extends SpleefWagerInviteEvent{
        ...
        private Player player, target;
        private Wager wager;
        public Post(SpleefPluginV1_12 pl, Player p, Player p2, Wager wager) {
