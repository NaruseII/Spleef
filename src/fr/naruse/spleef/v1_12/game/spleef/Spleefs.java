...
import fr.naruse.spleef.v1_12.api.event.cancellable.loading.SpleefLoadingArenasEvent;
import fr.naruse.spleef.v1_12.game.spleef.type.*;
...
public class Spleefs {
    ...
    public Spleefs(SpleefPluginV1_12 pl) {
        this.pl = pl;
        int count = 0;
        for(int i = 0; i != 999; i++){
